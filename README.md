...
Be careful when updating a plugin from GitHub when the plugin was installed via the [Shopware store](http://store.shopware.com/wirecard01501/wirecard-checkout-page.html). If you update to the latest version of GitHub, your Shopware installation will notify you about an upgrade for the plugin due to changes in the files. **This upgrade will revert the changes you made.**
