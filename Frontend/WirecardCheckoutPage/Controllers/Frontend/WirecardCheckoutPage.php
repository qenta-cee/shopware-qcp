...
class Shopware_Controllers_Frontend_WirecardCheckoutPage extends Shopware_Controllers_Frontend_Payment implements CSRFWhitelistAware
{
    ...
    public function confirmAction()
    {
        try {
            ...
            $return = WirecardCEE_QPay_ReturnFactory::getInstance($post, Shopware()->WirecardCheckoutPage()->getConfig()->SECRET);
     ...
     * Save return data
     *
     * @param WirecardCEE_QPay_Return_Success $return
     * @param null $orderNumber
     * @internal param null $transactionId
     */
    protected function saveComments(WirecardCEE_QPay_Return_Success $return = null, $orderNumber = null)
    {
        $comments = array();
